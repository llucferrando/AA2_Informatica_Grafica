...
Model LoadOBJModel(int IDProgram,const std::string& filePath, const char* texturefilePath) {
	...
	return Model(IDProgram,texturefilePath, vertexs, textureCoordinates, vertexNormal);
}
...
void main() {
	...
	if (glewInit() == GLEW_OK) {
		...
		//Cargo Modelo
		models.push_back(LoadOBJModel(0,"Assets/Models/troll.obj", "Assets/Textures/troll.png"));
